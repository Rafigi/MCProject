...
{
    public partial class McWorldDatabaseContext : DbContext
    {
        public McWorldDatabaseContext()
        {
        }

        public McWorldDatabaseContext(DbContextOptions<McWorldDatabaseContext> options)
            : base(options)
        {
        }
